...
describe('NoteList', () => {
  ...
  it('renders the correct amount of note Links when passed notes prop', () => {
    const wrapper = shallow(<NoteList notes={props.notes}/>)
    expect(wrapper.find('Link').length).toEqual(props.notes.length)
  });
